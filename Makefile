...
# Help target - dynamically lists top-level targets found in this Makefile
.PHONY: help
help:
	...
	@echo "  build-macos       : Build for macOS (64-bit)"
	...
	@echo "  test-verbose      : Run tests with detailed per-test timing"
	@echo "  test-slow         : Show slowest tests (profiling helpers)"
	@echo "  benchmark-tokens  : Benchmark token costs for tools"
	@echo "  list-tools        : List all tool definitions as seen by MCP clients"
	@echo "  test-docling-vlm  : Run VLM/LLM integration tests (requires .env)"
	@echo "  clean             : Clean build artefacts"
	@echo "  fmt               : Format code"
	@echo "  lint              : Lint code and modernise"
	...
	@echo "  sec-gosec         : Run gosec security scans"
	@echo "  sec-mcp-scan      : Run mcp-scan security scan"
	@echo "  sec-semgrep       : Run semgrep security scan"
	@echo "  sec-safedep-vet   : Run safedep vet scan"
	...
	@echo "  inspect           : Run MCP inspector tool"
